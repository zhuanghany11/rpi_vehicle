...
set(MSG_I_FLAGS "-Icommon:/home/pi/Desktop/Robots/rpi_vehicle/src/common/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/Desktop/Robots/rpi_vehicle/src/common/msg/RemoteControlMsg.msg" NAME_WE)
add_custom_target(_common_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "common" "/home/pi/Desktop/Robots/rpi_vehicle/src/common/msg/RemoteControlMsg.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(common
  "/home/pi/Desktop/Robots/rpi_vehicle/src/common/msg/RemoteControlMsg.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/common)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/common\")")
  # install generated code
  install(
