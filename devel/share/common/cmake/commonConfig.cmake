...
if("TRUE" STREQUAL "TRUE")
  set(common_SOURCE_PREFIX /home/pi/Desktop/Robots/rpi_vehicle/src/common)
  set(common_DEVEL_PREFIX /home/pi/Desktop/Robots/rpi_vehicle/devel)
  set(common_INSTALL_PREFIX "")
  set(common_PREFIX ${common_DEVEL_PREFIX})
else()
  set(common_SOURCE_PREFIX "")
  set(common_DEVEL_PREFIX "")
  set(common_INSTALL_PREFIX /home/pi/Desktop/Robots/rpi_vehicle/install)
...
if(NOT "/home/pi/Desktop/Robots/rpi_vehicle/devel/include " STREQUAL " ")
  set(common_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/Desktop/Robots/rpi_vehicle/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zhy <zhuanghany11@163.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Desktop/Robots/rpi_vehicle/src/common/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/Desktop/Robots/rpi_vehicle/devel/lib;/home/pi/Desktop/Robots/rpi_vehicle/devel/lib;/opt/ros/kinetic/lib)
